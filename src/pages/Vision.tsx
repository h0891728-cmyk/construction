...
import { Cpu, Globe, Layers, Users, CheckCircle, ArrowRight, Zap, TrendingUp, Target } from 'lucide-react';
...
const Vision: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Vision 2026 - Our Strategy" 
        description="Our roadmap for transforming into a full-scale EPC engineering company by 2026, powered by technology, talent, and tenacity." 
        keywords="Engineering Vision, EPC Strategy, Infrastructure Goals 2026, SCAE Roadmap"
      />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            <AnimatedSection direction="left">
              ...
              <p style={{ color: '#4B5563', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.925rem' }}>
                Today, SCAE operates as a high-performance subcontractor — a trusted execution arm for India's largest
                EPC contractors and government power utilities. Our 10+ year track record demonstrates consistent delivery
            ...
            <AnimatedSection direction="right">
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                {[
                  { v: 10, s: '+', l: 'Years Active', c: '#1B4F8A' },
                  { v: 7, s: '+', l: 'Projects Done', c: '#D97706' },
                  { v: 5, s: '', l: 'Major Clients', c: '#7C3AED' },
                ].map((st, i) => (
