        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr 1.3fr', gap: '3rem' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.25rem' }}>
              <div style={{ width: 40, height: 40, background: '#1B4F8A', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: '0.72rem', flexShrink: 0 }}>SCE</div>
              <div>
                <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: '0.88rem', color: '#fff', lineHeight: 1.3 }}>Saraswati Construction</div>
                <div style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.35)' }}>& Enterprise</div>
              </div>
            </div>
            <p style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.45)', lineHeight: 1.75, marginBottom: '1.5rem' }}>
              MSME registered firm delivering excellence in Electrical & Civil Engineering since 2017.
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none' }}>
              {[
                ...
                { l: 'Projects', p: '/projects' }, { l: 'Gallery', p: '/gallery' }, { l: 'Vision', p: '/vision' }, { l: 'Contact Us', p: '/contact' },
              ].map(n => (
          ...
          {/* Services */}
          <div>
            <h4 style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: '0.82rem', color: '#fff', marginBottom: '1.25rem', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Services</h4>
            <ul style={{ listStyle: 'none' }}>
              {['11/33 KV Substation Installation', 'Civil Building Construction', 'Highway Crash Barriers', 'Solar Panel Installation', 'Electrical Commissioning', 'Material Supply & Procurement'].map(s => (
                <li key={s} style={{ marginBottom: '0.5rem', display: 'flex', alignItems: 'flex-start', gap: '0.4rem' }}>
                  <span style={{ width: 4, height: 4, borderRadius: '50%', background: '#F4A623', flexShrink: 0, marginTop: '0.45rem' }} />
                  <span style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.4)', lineHeight: 1.5 }}>{s}</span>
                </li>
              ))}
            </ul>
          </div>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', background: 'rgba(0,0,0,0.25)' }}>
        <div className="wrap" style={{ padding: '1rem var(--px)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem' }}>
          <span style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.3)' }}>
            © {year} Saraswati Construction and Enterprise. All Rights Reserved.
          </span>
          <span style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.3)' }}>
