    ...
    <>
      ...
      <header className="navbar" style={{ boxShadow: scrolled ? '0 4px 20px rgba(0,0,0,0.1)' : 'none' }}>
        <div className="wrap" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
          ...
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', textDecoration: 'none' }}>
            ...
            <div>
              <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: '0.9rem', color: '#0D1117', lineHeight: 1.2 }}>
                Saraswati Construction
              </div>
              <div style={{ fontSize: '0.68rem', color: '#6B7280' }}>& Enterprise</div>
            </div>
          </Link>
      ...
      <div className={`mobile-menu ${open ? 'open' : ''}`}>
        ...
        <div style={{ position: 'absolute', top: 18, left: 20, display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
          <div style={{ width: 36, height: 36, background: 'rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: '0.7rem' }}>SCE</div>
          <span style={{ color: 'rgba(255,255,255,0.75)', fontSize: '0.82rem', fontWeight: 600 }}>Saraswati Construction</span>
        </div>
